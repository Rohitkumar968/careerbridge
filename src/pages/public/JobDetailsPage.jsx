...
import { ArrowLeft, Bookmark, CheckCircle, MapPin, Briefcase, Clock } from 'lucide-react'
    ...
    try {
      ...
      if (savedResponse.data?.success) {
        ...
        const savedIds = savedJobs.map((savedJob) => {
          if (typeof savedJob === 'string') return savedJob
              ...
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-5">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="w-16 h-16 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0">
                    <Briefcase className="text-blue-600 dark:text-blue-400" size={30} />
                  </div>
